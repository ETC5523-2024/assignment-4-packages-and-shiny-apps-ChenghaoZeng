#' Valentine's Day Consumer Spending Data from 2010 to 2022
#'
#' A dataset containing historical consumer spending trends on Valentine's Day in the United States across multiple categories, from the years 2010 to 2022.
#'
#' @format ## 'historical_spending'
#' A data frame with 13 rows and 10 columns:
#' \describe{
