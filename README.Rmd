...
ggplot(historical_spending, aes(x = Year, y = PercentCelebrating)) +
  ...
  theme_minimal() 
```
## Main Components of valentineTool Package
...
- Package Documentation and Examples
  ...
  - README: The README provides an overview of the package, how to install it, and basic examples of how to use its features.
  It also contains installation instructions using remotes::install_github() and examples to help users get started.
